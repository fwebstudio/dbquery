...
$sql['limit']	= 2;
$sql['offset']	= 1;
$sql['order']	= "c_name ASC, c_email DESC";
...
<body>
	<h1>Query dengan Mengurutkan Berdasarkan kolom</h1>
	...
	<pre>
		...
		$sql['limit'] : Tipe data int
		$sql['offset']: Tipe data int
		$sql['order'] : Tipe data string
